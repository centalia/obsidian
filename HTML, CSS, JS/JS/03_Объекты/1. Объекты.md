...
Дабы избежать такого есть методы поверхностного копирования и методы глубоко копирования 
...
Есть другой способ через `...` (оператор разделения объекта)
...
Но есть одно НО! Если у объекта есть вложенные объекты, то ссылки на них сохраняются. 