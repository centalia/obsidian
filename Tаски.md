...
- [x] Сделать форму добавления тайтла
- [ ] Сделать форму удаления тайтла
- [ ] Сделать форму редактирования тайтла
- [ ] Нотификация
	- [x] при добавлении тайтла
	- [ ] при удалении тайтла
	- [ ] при редактировании тайтла
- [ ] Привязать логику сортировки к HTML-кнопкам
- [ ] Сделать черновой адаптив для мобильных устройств
- [x] Пофискить стили с нормалайзером
- [ ] Перевести все цвета в oklch
- [ ] Перевести CSS-стили в SCSS
- [x] Попытаться сделать рабочую серверную часть
- [x] Сделать добавление в временный массив данных
- [ ] Развернуть IndexedDB во фронте
- [ ] Развернуть MondoDB в беке
---
## CSS  
