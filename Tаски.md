...
- [x] Сделать форму добавления тайтла
	- [x] Кнопка, вызывающая модальное окно 
	- [x] Модальное окно
		- [x] Кнопка закрыть окно
		- [x] Клики по оверлею закрывают окно
		- [x] Нажатие Esc закрывает окно
		- [x] Кнопка Добавить тайтл закрывает окно
